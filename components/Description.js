    ...
    return (
        <div>
            ...
            <div className="container mx-auto">
                <section className="mx-auto my-12 flex items-center font-sans justify-center px-0 md:px-8 py-16 bg-gray-100 rounded-3xl" style={{ width: "80%", background: 'linear-gradient(76.57deg, #0E0918 34.14%, #4A2F7E 94.67%)', }}>
                    {/* Left Section */}
                    <div className="w-full md:w-1/2 text-white  md:space-y-0 md:space-y-6 mx-6 md:mx-12">
